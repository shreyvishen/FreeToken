...
# The tiled kernel reads every routed expert's weights in full whatever M is (~5.8 ms). At the
# 35B's shapes it ties at M 224 and leads from 256 (2.1x at 512); bench_moe_prefill.py measures.
_TILED_MIN_M = 256
