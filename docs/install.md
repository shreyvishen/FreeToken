...
- torch 2.10 or 2.11, with MPS (the Metal path is verified on 2.10)
...
Serving then works as on CUDA ([quickstart.md](quickstart.md)); the models tested on Metal, the
Metal flags and the SSD tier's knobs are in [models.md](models.md#runtime-flags-on-metal-macos).
